...
bool custom_messages__msg__spark_max_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_messages.msg._spark_max_message.SparkMaxMessage", full_classname_dest, 54) == 0);
  }
  custom_messages__msg__SparkMaxMessage * ros_message = _ros_message;
  {  // device_id
  ...
  {  // applied_output
    PyObject * field = PyObject_GetAttrString(_pymsg, "applied_output");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->applied_output = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // velocity
...
{
  /* NOTE(esteve): Call constructor of SparkMaxMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_messages.msg._spark_max_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SparkMaxMessage");
  ...
  {  // applied_output
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->applied_output);
    {
      int rc = PyObject_SetAttrString(_pymessage, "applied_output", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
